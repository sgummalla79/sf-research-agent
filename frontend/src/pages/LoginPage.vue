    ...
    <div class="login-card">
      ...
      <div class="login-brand">
        <svg width="64" height="64" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g stroke="#c97040" stroke-width="3">
...
.login-app-name {
  font-family: 'Martel', serif; font-size: 32px; font-weight: 700;
  color: #ececea; letter-spacing: -0.5px; line-height: 1;
}
.login-app-sub  { font-size: 13px; color: #737373; margin-top: -4px; }
